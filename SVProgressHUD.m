...
- (void)dismissWithStatus:(NSString*)string error:(BOOL)error {
    ...
    //Modified to work with Titanium Mobile's asset bundling.
    
    if(error) {
        NSURL *url = [TiUtils toURL:@"modules/com.svprogresshud/SVProgressHUD.bundle/error.png" proxy:nil];
        self.imageView.image = [TiUtils image:url proxy:nil];
        //self.imageView.image = [UIImage imageNamed:@"modules/com.svprogresshud/error.png"];
    }
	else {
		NSURL *url = [TiUtils toURL:@"modules/com.svprogresshud/SVProgressHUD.bundle/success.png" proxy:nil];
        self.imageView.image = [TiUtils image:url proxy:nil];
        //self.imageView.image = [UIImage imageNamed:@"modules/com.svprogresshud/success.png"];
    }
